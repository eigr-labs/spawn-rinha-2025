...
defmodule Io.Eigr.Labs.Spawn.Rinha.PaymentSummary do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
  ...
  field :from, 2, type: :string, deprecated: false
  field :to, 3, type: :string, deprecated: false
  field :default, 4, type: Io.Eigr.Labs.Spawn.Rinha.Totals
  field :fallback, 5, type: Io.Eigr.Labs.Spawn.Rinha.Totals
end
